...
var fly_eaten_scene = preload("res://Scenes/fly_eaten.tscn")
var loop_completed_scene = preload("res://Scenes/loop_created.tscn")
var thread_built_scene = preload("res://Scenes/thread_built.tscn")
