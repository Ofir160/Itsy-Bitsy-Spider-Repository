...
func _ready() -> void:
	scenes = [cutscene_1, level_1, cutscene_2, cutscene_3, level_2, cutscene_4, cutscene_5, cutscene_6, level_3, cutscene_7, cutscene_8]
	music = [morning, carpe_diem, carpe_diem, carpe_diem, mischief_maker, montauk_point, montauk_point, intrepid, satiate, royal_coupling, morning]
	current_scene = 0
	playing = true
